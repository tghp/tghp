...
export default function About() {
  return (
    <Main.Container>
      <Main.OverCanvas className="px-10 py-12 [font-stretch:130%] font-light">
        <div className="prose prose-base prose-xl max-w-[65rem]">
          <p>
            ...
            needs and requirements. We will work with you to ensure any digital
            solution we provide be that web design, development or digital
            marketing is going to make a big difference to your bottom line.
          </p>
          <p>
            ...
            experts in the UK, allowing us to build the perfect team tailored to
            solving your digital problems.
          </p>
        </div>
      </Main.OverCanvas>
      <Divider />
      <Main.OverCanvas className="px-10 py-12 [font-stretch:130%] font-light">
        <div className="prose prose-base prose-xl max-w-[65rem]">
          We have a small core team but we work with a select group of the most
          talented Designers and Developers all based in the UK on a project by
          project basis. This means that whatever your digital problem we can
          always create the best team to solve it for you. We pride ourselves in
          producing quality, functional websites with clean SEO friendly code
          and we always hit our deadlines.
        </div>
      </Main.OverCanvas>
      <Divider />
      <Main.OverCanvas className="px-10 py-12 [font-stretch:130%] font-light">
